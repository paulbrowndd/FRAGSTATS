(function () {
  ...
  function updateAuthChrome() {
    ...
    viewTabs.forEach((btn) => {
      ...
      const locked = !isPublicView(view) && !unlocked;
  ...
  function renderBingoBookTabBody() {
    hideStatsPanels();
    setMainViewChrome(VIEW.BINGO_BOOK);
  ...
  function renderBody() {
    ...
    if (currentView === VIEW.BINGO_BOOK) {
      renderBingoBookTabBody();
      return;
    }
